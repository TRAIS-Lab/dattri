...
from dattri.params.projection import GeneralProjectionParams
...
class BlockProjectedIFAttributor(BaseAttributor):
    ...
    def __init__(
        ...
        device: str = "cpu",
        sparsifier_params: Optional[GeneralProjectionParams] = None,
        projector_params: Optional[GeneralProjectionParams] = None,
        ...
        self.projector_params = projector_params or GeneralProjectionParams(
            proj_dim=-1,
            proj_max_batch_size=64,
            proj_type="identity",
        )
